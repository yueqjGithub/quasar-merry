...
import section1 from 'pages/module8/section1'
import section2 from 'pages/module8/section2'
import section3 from 'pages/module8/section3'
import section4 from 'pages/module8/section4'
import section5 from 'pages/module8/section5'
import section6 from 'pages/module8/section6'
import section7 from 'pages/module8/section7'
import section8 from 'pages/module8/section8'
import section9 from 'pages/module8/section9'
export default {
  components: {
    myLoading,
    section1,
...
.page-container{
  ...
  .m8-img-out-sub{
    ...
    &::before{
      ...
      width: .15rem;
      height: .25rem;
      background: url('~assets/module8/m8s3p2.png');
      background-size: 100% 100%;
      position: absolute;
      top: -.12rem;
      left: .4rem;
